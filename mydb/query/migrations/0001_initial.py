# Generated by Django 3.0.2 on 2020-03-18 02:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='query.Color')),
                ('state_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='query.State')),
            ],
        ),
        migrations.CreateModel(
            name='Player',
            fields=[
                ...
                ('team_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='query.Team')),
            ],
        ),
    ]
